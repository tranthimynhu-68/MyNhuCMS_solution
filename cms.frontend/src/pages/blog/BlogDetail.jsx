        ...
        <>
            <style>
                {`
                    ...
                    .post-detail-card .post-header .post-title {
                        font-size: 2.2rem;
                        font-weight: 800;
                        color: #2c3e50;
                        line-height: 1.3;
                    ...
                    .post-detail-card .post-header .post-meta {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 20px;
                        align-items: center;
                    ...
                    .post-detail-card .post-header .post-meta i {
                        margin-right: 5px;
                    }
                    .post-detail-card .post-header .post-category {
                        background: #e74c3c;
                        color: #fff;
                        padding: 4px 16px;
                        border-radius: 50px;
                    ...
                    .post-detail-card .post-footer .post-tags {
                        display: flex;
                        gap: 8px;
                        flex-wrap: wrap;
                    }
                    .post-detail-card .post-footer .post-tags .tag {
                        background: #f0f0f0;
                        padding: 4px 14px;
                        border-radius: 50px;
                        font-size: 0.85rem;
                    ...
                    .post-detail-card .post-footer .post-actions {
                        display: flex;
                        gap: 10px;
                    }
                    .post-detail-card .post-footer .post-actions button {
                        background: none;
                        border: none;
                        color: #6c757d;
                    ...
                    .post-detail-card .post-footer .post-actions button:hover {
                        color: #e74c3c;
                        background: #fde8e8;
                    }
                    .related-posts {
